            ...
            <ul class="navbar-nav flex-column" id="sideNavbar">
                ...
                <li class="nav-item">
                    <a class="nav-link has-arrow  collapsed " href="#!" data-bs-toggle="collapse"
                        ...
                        <svg style="margin-right: 5px" fill="#9199a5" width="18" height="18"
                ...
                <li class="nav-item">
                    <a class="nav-link has-arrow  collapsed " href="#!" data-bs-toggle="collapse"
                        ...
                        <svg style="margin-right: 8px" fill="#9199a5" height="15px" width="15px" version="1.1"
                        ...
                        <svg style="margin-right: 5px" width="18px" height="18px" viewBox="0 0 24.00 24.00"
                            ...
                            <g id="SVGRepo_iconCarrier">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    stroke="#9199a5" stroke-width="1.224" stroke-linecap="round"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    stroke-linejoin="round"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M2.92499 8.75195V13.372H8.92904V8.75195H2.92499Z" stroke="#9199a5"
