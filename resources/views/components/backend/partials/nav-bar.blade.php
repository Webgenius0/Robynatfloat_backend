    ...
    <div class="navbar-vertical navbar nav-dashboard">
        <div class="h-100" data-simplebar>
            ...
            <ul class="navbar-nav flex-column" id="sideNavbar">
                ...
                <!-- Nav item crue start -->
                <li class="nav-item">
                    <a class="nav-link has-arrow  collapsed {{request()->routeIs('admin.user.crue.*') ? 'active' : ''}}" href="#!" data-bs-toggle="collapse"
                        data-bs-target="#crue" aria-expanded="false" aria-controls="crue">
                        <svg style="margin-right: 5px" fill="{{request()->routeIs('admin.user.crue.*') ? '#624bff' : '#9199a5'}}" width="18" height="18"
                            viewBox="0 0 100 100" id="Layer_1" version="1.1" xml:space="preserve"
                    ...
                    <div id="crue" class="collapse {{ request()->routeIs('admin.user.crue.*') ? 'show' : '' }}" data-bs-parent="#sideNavbar">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link has-arrow {{request()->routeIs('admin.user.crue.index') ? 'active' : ''}}" href="{{route('admin.user.crue.index')}}">
                                    Crue List
                                </a>
                            </li>
                        </ul>
                ...
                <li class="nav-item">
                    <a class="nav-link has-arrow  collapsed {{request()->routeIs('admin.user.freelancer.*') ? 'active' : ''}}" href="#!" data-bs-toggle="collapse"
                        data-bs-target="#freelancers" aria-expanded="false" aria-controls="freelancers">
                        <svg style="margin-right: 8px" fill="{{request()->routeIs('admin.user.freelancer.*') ? '#624bff' : '#9199a5'}}" height="15px" width="15px" version="1.1"
                            id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 198.744 198.743"
                            xml:space="preserve">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                    ...
                    <div id="freelancers" class="collapse {{ request()->routeIs('admin.user.freelancer.*') ? 'show' : '' }}" data-bs-parent="#sideNavbar">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link has-arrow {{request()->routeIs('admin.user.freelancer.index') ? 'active' : ''}}" href="{{route('admin.user.freelancer.index')}}">
                                    Freelancers List
                                </a>
                            </li>
                        </ul>
                ...
                <li class="nav-item">
                    <a class="nav-link has-arrow  collapsed {{request()->routeIs('admin.user.supplier.*') ? 'active' : ''}}" href="#!" data-bs-toggle="collapse"
                        ...
                        <svg style="margin-right: 5px" width="18px" height="18px" viewBox="0 0 24.00 24.00"
                            ...
                            <g id="SVGRepo_iconCarrier">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    stroke="{{request()->routeIs('admin.user.supplier.*') ? '#624bff' : '#9199a5'}}" stroke-width="1.224" stroke-linecap="round"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    stroke-linejoin="round"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M2.92499 8.75195V13.372H8.92904V8.75195H2.92499Z" stroke="{{request()->routeIs('admin.user.supplier.*') ? '#624bff' : '#9199a5'}}"
                                ...
                                <path
                                    ...
                                    fill="{{request()->routeIs('admin.user.supplier.*') ? '#624bff' : '#9199a5'}}"></path>
                            </g>
                        </svg>
                        Suppliers
                    </a>

                    <div id="suppliers" class="collapse {{ request()->routeIs('admin.user.supplier.*') ? 'show' : '' }}" data-bs-parent="#sideNavbar">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link has-arrow {{request()->routeIs('admin.user.supplier.index') ? 'active' : ''}}" href="{{route('admin.user.supplier.index')}}">
                                    Suppliers List
                                </a>
                            </li>
                        </ul>
                ...
                <li class="nav-item">
                    <a class="nav-link has-arrow  collapsed {{request()->routeIs('admin.user.yacth.*') ? 'active' : ''}}" href="#!" data-bs-toggle="collapse"
                        data-bs-target="#yacth" aria-expanded="false" aria-controls="yacth">
                        <svg style="margin-right: 8px" fill="{{request()->routeIs('admin.user.yacth.*') ? '#624bff' : '#9199a5'}}" height="15px" width="15px" version="1.1"
                            id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.252 512.252"
                            xml:space="preserve">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                    ...
                    <div id="yacth" class="collapse {{ request()->routeIs('admin.user.yacth.*') ? 'show' : '' }}" data-bs-parent="#sideNavbar">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link has-arrow {{request()->routeIs('admin.user.yacth.index') ? 'active' : ''}}" href="{{route('admin.user.yacth.index')}}">
                                    Yacth List
                                </a>
                            </li>
                        </ul>
