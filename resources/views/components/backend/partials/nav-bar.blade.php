...
<li class="nav-item">
    <a class="nav-link {{ request()->routeIs('admin.subscription.plan.*') ? 'active' : '' }}"
        ...
        <svg fill="{{ request()->routeIs('admin.subscription.plan.*') ? '#4caf50' : '#9e9e9e' }}"
            height="18px" width="18px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
            style="margin-right: 5px">
            <path d="M12 2a10 10 0 110 20 10 10 0 010-20zm0 2a8 8 0 100 16 8 8 0 000-16zm-1 10V7h2v7h-2zm0 4h2v2h-2v-2z"></path>
        </svg>
        Subscription Plan
    </a>
</li>
...
<li class="nav-item">
    <a class="nav-link {{ request()->routeIs('admin.subscription.featurePlan.*') ? 'active' : '' }}"
        href="{{ route('admin.subscription.featurePlan.index') }}">
        <svg fill="{{ request()->routeIs('admin.subscription.featurePlan.*') ? '#ff9800' : '#9e9e9e' }}"
            height="18px" width="18px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
            style="margin-right: 5px">
            <path d="M12 2a10 10 0 110 20 10 10 0 010-20zm0 2a8 8 0 100 16 8 8 0 000-16zm-1 4h2v4h-2V8zm0 6h2v2h-2v-2z"></path>
        </svg>
