...
class SupplierManageProductRepository implements SupplierManageProductRepositoryInterface
{
...
public function addSupplierProduct(array $credentials): Product
{
    ...
    return $product;
        ...
        Log::error('App\Repositories\API\V1\Supplier\SupplierManageProductRepository::addSupplierProduct', ['error' => $e->getMessage()]);
        throw $e;
    }
...
public function getSupplierProductById($slug)
{
    try {
        ...
        Log::error('App\Repositories\API\V1\Supplier\SupplierManageProductRepository:getSupplierProductById', ['error' => $e->getMessage()]);
        throw $e;
    }
}
...
try {
    ...
    Log::error('App\Repositories\API\V1\Supplier\SupplierManageProductRepository:updateSupplierProduct', ['error' => $e->getMessage()]);
...
public function deleteSupplierProduct($slug)
{
    try {
        ...
        Log::error('App\Repositories\API\V1\Supplier\SupplierManageProductRepository:deleteSupplierProduct', ['error' => $e->getMessage()]);
        throw $e;
    }
}
